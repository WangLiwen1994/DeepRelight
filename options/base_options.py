...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='2020-07-14_2Stage_BP_light_HDR_color', help='name of the experiment. It decides where to store samples and models')
